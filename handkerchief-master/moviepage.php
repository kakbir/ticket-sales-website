<html>
	...
	<body>
        <div id="header">
            <div id="logo">
                <a href="index.php">Blok Seçiniz</a>
            </div>
        </div>
		<div id="main">
            ...
            <div id='movie_right'>
            <?php
            echo "<span id='name'>".$name."</span><span id='movie_info'>".$language."  &nbsp;|&nbsp;  ".$genre."  &nbsp;|&nbsp;  ".$certificate."<br>Maç Tarihi: ".$release_date."<br>Etkinlik Süresi: ".$runtime." mins </span>";
            ?>
            ...
            <form id='showForm' method='post' action='screenpage.php'>
